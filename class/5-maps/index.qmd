...
## Time to start thinking about your final project {.smaller-title}
![](images/finals-are-coming.png)
...
See [course website](https://pubh6199-data-viz-with-r.github.io/2026-Summer/project/0-overview.html) for project details and deadlines.
...
Follow [this tutorial](https://walker-data.com/tidycensus/articles/basic-usage.html) on how to get started with `{tidycensus}` packages. 
Remember to add your `.Renviron` to `.gitignore` so that you do not share your API keys. 
...
<p class="caption-text">*~ This is the end of Lecture 3 ~*</p>
</div>
