...
## Meet your LA {.smaller}


![](images/bogdan-headshot.jpeg){style="border-radius: 70%; width: 70%; display: block; margin: auto;"}

::: citation
Bogdan Bunea

BS'26 Systems Engineering
...
-   **Homework** (4 weekly assignments): 35%
-   **Lab** (4 weekly lab notebooks): 15%
...
## Before we talk about genAI policy {.fit-text .smaller}
::: {.column width="60%"}

[Source: Anthropic](https://www.anthropic.com/research/AI-assistance-coding-skills)

![](images/claude-study.png){style="display: block; margin: auto;"}
:::

:::{.column width = "40%"}
A randomized controlled trial.

- Using AI assistance led to a statistically significant decrease in mastery (17% lower) 

- Using AI sped up the task slightly, but not statistically significant.

- How someone used AI influenced how much information they retained.

:::
## GenAI policy {.fit-text .smaller}
...
-   Use **Study Mode ChatGPT**, **Claude Learning Mode**, or [**LearnLM in Gemini**](https://blog.google/products-and-platforms/products/education/guided-learning/)
:::
:::

:::{.column width = "50%"}
![](images/active-learning-techniques.png){style="display: block; margin: auto;"}
:::

## Communication {.fit-text .smaller}

-   Slack: PUBH 6199 channel
-   Course website: [https://pubh6199-data-viz-with-r.github.io/2026-Summer/](https://pubh6199-data-viz-with-r.github.io/2026-Summer/)
-   Blackboard
-   Office hours:
    -   Bogdan: Fridays 1-2pm
