...
::: {style="width:900px"}
| Instructor | LA | Course |
|------------------|------------------|------------------|------------------|
| <i class="bi-person-fill"></i> Xindi (Cindy) Hu, ScD | <i class="bi-person-fill"></i> Bogdan Bunea | <i class="bi-clock-fill"></i> {{< var weekday >}} {{< var time >}} |
| <i class="bi-building-fill"></i> Milken #412 or [Zoom]({{< var prof-zoom>}}) | <i class="bi-building-fill"></i> [Google Meet]({{<var ta-google-meet>}}) | <i class="bi-geo-alt-fill"></i> [{{< var room >}}]({{< var room_url >}}) |
| <i class="bi-telephone-fill"></i> +1 (202) 994-7766 | <i class="bi-telephone-fill"></i> NA | <i class="bi-calendar-week-fill"></i> {{< var dates >}} |
| <i class="bi-envelope-fill"></i> [Email Prof. Hu](mailto:{{< var email >}}) | <i class="bi-envelope-fill"></i> [Email Bogdan](mailto:{{< var ta-email >}})  | <i class="bi-slack"></i> [Slack]({{< var slack >}}){target="_blank"} |
| <i class="bi-clock-fill"></i> [By appointment](https://calendly.com/xindi-hu/pubh6199-office-hour) | <i class="bi-clock-fill"></i> F 1-2PM ET  | <img src="images/rubber-duck.png" width="30"/> Class mascot |
:::
...
| Final Project: Prototype V1 | 7 % | Due June 23rd |
| Final Project: Data visualization product | 18 % | Due June 25th  |
| Final Project: Presentation | 10 % | Due June 25th |
| Final Project: Peer evaluation | 5 % | Due June 25th |
:::
...
Our LA will hold regular office hour each Friday 1-2pm (Bogdan, [Google Meet](https://meet.google.com/ggz-pmkx-apf). Please don't make your LA sit and do emails for two hours - come by and ask for help!

If the office hours don't work with your schedule, you can always schedule a zoom call with Prof.Hu using [this link](https://calendly.com/xindi-hu/pubh6199-office-hour).


## Library Services

While the University Library is not a stand in for LA, you can schedule a consultation for general help with Coding, Programming, Data, Statistical, and GIS. See more at [academiccommons.gwu.edu/writing-research-help](https://academiccommons.gwu.edu/writing-research-help)
