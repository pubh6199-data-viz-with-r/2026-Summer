...
| <i class="bi-building-fill"></i> Milken #412 or [Zoom]({{< var prof-zoom>}}) | <i class="bi-building-fill"></i> [Zoom]({{<var ta-zoom>}}) | <i class="bi-geo-alt-fill"></i> [{{< var room >}}]({{< var room_url >}}) |
...
| <i class="bi-clock-fill"></i> [By appointment](https://calendly.com/xindi-hu/pubh6199-office-hour) | <i class="bi-clock-fill"></i> W 2-3PM ET  | <img src="images/rubber-duck.png" width="30"/> Class mascot |
:::
